...
export const agentDefinitions = {
	"claude-code": {
		...
		commands: {
			...
			steeringCustom:
				"`/kiro:steering-custom <what-to-create-custom-steering-document>`",
		},
	...
	codex: {
		...
		recommendedModels: [
			"Planning / review: gpt-5.4 high or xhigh",
		...
		commands: {
			...
			steeringCustom:
				"`/prompts:kiro-steering-custom <what-to-create-custom-steering-document>`",
		},
	...
	cursor: {
		...
		aliasFlags: ["--cursor"],
		recommendedModels: [
			"Planning / review: Claude Opus 4.6 or newer / gpt-5.4 high",
			"Implementation: Claude Sonnet 4.6 or newer / gpt-5.4 / Composer 2",
		],
		layout: {
	...
	"github-copilot": {
		...
		recommendedModels: [
			"Planning / review: Claude Opus 4.6 or newer / gpt-5.4 high",
			"Implementation: Claude Sonnet 4.6 or newer / gpt-5.4",
		],
		layout: {
	...
	"gemini-cli": {
		...
		recommendedModels: [
			"Planning / review: Gemini 3.1 Pro or newer",
			"Implementation: Gemini 3 Flash or newer",
		],
		layout: {
