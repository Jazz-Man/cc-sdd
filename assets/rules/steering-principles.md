...
- Detailed documentation of tooling metadata directories (settings, automation)
...
- Light references to `.sdd/specs/` and `.claude/rules/` are acceptable; avoid documenting other tool-managed directories in detail
