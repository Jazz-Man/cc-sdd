...
EARS patterns describe the logical structure of a requirement (condition + subject + response).
All acceptance criteria are written in English — English is the fixed output language, and no per-specification language configuration exists.
