...
- If the design reveals multiple independent responsibility seams that could move separately, stop and split the spec — the extra seams become separately queued follow-up features — instead of forcing them into one spec.
